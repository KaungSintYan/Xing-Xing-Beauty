...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Xing Xing's Beauty - မျက်တောင်ဆက် / မျက်တောင်ကောက်</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 h-6">
                        <h2 class="l-mm mb-5" style="font-size: 55px;"> မျက်တောင်ဆက် - မျက်တောင်ကောက် - Service </h2>
                        <h2 class="l-ch mb-5" style="font-size: 55px;"> 睫毛延长 - 翘起的睫毛 - Service </h2>
                        <h2 class="l-en mb-5" style="font-size: 55px;"> Eyelash extension - Raised eyelashes   Service </h2>
                    </div>
                    <div class="col-12">
        ...
        <div class="container" style="margin-top: 20px;">
            <table class="table">
                <tr>
                    ...
                    <th>မျက်တောင်ဆက် - မျက်တောင်ကောက်</th>
                    <th>Action</th>
                </tr>
                <tr>
