...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Xing Xing's Beauty - နှုတ်ခမ်းအရောင်သွင်းခြင်း </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 h-6">
                        <h2 class="l-mm">နှုတ်ခမ်းအရောင်သွင်းခြင်း - Service</h2>
                        <h2 class="l-en">Lip tinting - Service</h2>
                        <h2 class="l-ch">唇彩 - Service</h2>
                    </div>
                    <div class="col-12">
                ...
                <div class="textborder">
                        ...
                        <p style="font-size:17px; margin-left: 20px;" class="l-en">
                            💁‍♀️ Lip color is uneven
                             💁‍♀️ Because the side frame areas are dark
                             💁‍♀️ due to pale lips
                             💁‍♀️For those who have bad lipstick but don't like unnatural color, Xing Xing's Beauty's Coloring BBLips will solve everything 👄
                             Just hide the color of the lips? Lip color only? Xing Xing's Beauty's professional and innovative teachers are already taking responsibility for creating beauty products to make them stand out from the crowd.
                        ...
                        <p style="font-size:17px; margin-left: 20px;" class="l-ch">
                            💁‍♀️ 唇色不均匀
                             💁‍♀️ 因为侧框区域比较暗
                             💁‍♀️因为嘴唇苍白
                             💁‍♀️口红不好但又不喜欢颜色不自然的人，星星美颜BB唇膏解决一切👄
                             只是隐藏嘴唇的颜色？ 只有唇色？ Xing Xing's Beauty 的专业和创新教师已经开始负责创造美容产品，使其脱颖而出。
                             📞 电话 09781122838 <br>
        ...
        <div class="container" style="margin-top: 20px;">
            <table class="table">
                <tr>
                    ...
                    <th class="l-mm">နှုတ်ခမ်းအရောင်သွင်းခြင်း</th>
                    <th class="l-en">lips tinting</th>
                    <th class="l-ch">唇彩</th>
                    <th>Action</th>
                </tr>
                <tr>
