...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Xing Xing's Beauty - အမျှင် </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 h-6">
                        <h2 class="l-mm">အမျှင် - Service</h2>
                        <h2 class="l-en">Fiber - Service</h2>
                        <h2 class="l-ch">纤维 - Service</h2>
                    </div>
                    <div class="col-12">
            ...
            <div style="display: flex; flex-direction: row; justify-content: space-evenly;">
                ...
                <div class="textborder">
                        <p style="font-size:17px; margin-left: 20px;" class="l-mm">
                           ...
                           📍အောင်မင်းကောင် ၂လမ်း ၊ကမာရွတ်မြို့နယ် ၊ရန်ကုန်။ <br>
                        </p>
                        <p style="font-size:17px; margin-left: 20px;" class="l-en">
                            When I woke up, I had no eyebrows
                             ...
                             If you want to know more about how to always improve yourself, <br>
                              📞 Phone 09781122838 or you can come to the shop to discuss personally 💁‍♀️ <br>
                           📍Aung Min Gaung 2 Street , Kamayut Township , Yangon <br>
                        </p>
                        <p style="font-size:17px; margin-left: 20px;" class="l-ch">
                            当我醒来时，我没有眉毛
                             眉毛……秃头美人的感觉好难受🥺
                             每天早上，在涂任何东西之前，先涂上星星美眉，让镜子前的脸更显美丽👀
                             只是纤维吗？ 它只是一个粒子吗？ 纤维粒子是光吗？ Xing Xing's Beauty，专家老师使用德国和美国打造最美的产品。 我要快速预订，因为我会玩得很开心
                             如果您想了解更多有关如何不断提高自己的信息，<br>
                              📞电话09781122838 也可以来店面面谈💁‍♀️ <br>
                           📍仰光 Kamayut 乡 Aung Min Gaung 2 街。 <br>
                        </p>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="margin-top: 20px;">
            <table class="table">
                <tr>
                    ...
                    <th class="l-mm">အမျှင်</th>
                    <th class="l-en">Fiber</th>
                    <th class="l-ch">纤维</th>
                    <th>Action</th>
                </tr>
                <tr>
